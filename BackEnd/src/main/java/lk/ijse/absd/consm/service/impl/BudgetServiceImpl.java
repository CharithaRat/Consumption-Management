...
public class BudgetServiceImpl implements BudgetService {
    ...
    public List<BudgetDTO> getAllBudgets() {
        ...
        return budgets.stream().map(b -> new BudgetDTO(b.getBUDGET_ID(), b.getMODEL_ID(), b.getXBOM_ID(), b.getBOM_ID(), b.getBOM_TYPE(), b.getBOM_USAGE(),
    ...
    public BudgetDTO getBudget(String id) {
        ...
        return new BudgetDTO(bud.getBUDGET_ID(), bud.getMODEL_ID(), bud.getXBOM_ID(), bud.getBOM_ID(), bud.getBOM_TYPE(), bud.getBOM_USAGE(),
    ...
    public void saveBusget(BudgetDTO dto) {
        budgetRepository.save(new Budget(dto.getBUDGET_ID(), dto.getBOM_ID(), dto.getMODEL_ID(), dto.getXBOM_ID(), dto.getBOM_TYPE(), dto.getBOM_USAGE(),
    ...
    public void updateBudget(BudgetDTO dto) {
        budgetRepository.saveAndFlush(new Budget(dto.getBUDGET_ID(), dto.getBOM_ID(), dto.getMODEL_ID(), dto.getXBOM_ID(), dto.getBOM_TYPE(), dto.getBOM_USAGE(),
                dto.getLENGTH(), dto.getWIDTH(), dto.getHEIGHT(), dto.getBOM_COST(), dto.getNO_OF_BOM_UNITS(), dto.getREQ_AREA(), dto.getCOV_AREA_BY_CMT(),
                dto.getACT_COST(), dto.getBUD_DATE(), dto.getTTL_BUDGET_COST()));
    }
