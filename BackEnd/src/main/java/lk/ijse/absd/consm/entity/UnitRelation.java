...
//    public UnitRelation(String BASE_UNIT, List<Unit> units, String REL_UNIT, double UNIT_RATE) {
...
//    }
    ...
    public UnitRelation(String BASE_UNIT, String REL_UNIT, double UNIT_RATE) {
        this.BASE_UNIT = BASE_UNIT;
        this.REL_UNIT = REL_UNIT;
        this.UNIT_RATE = UNIT_RATE;
    }
