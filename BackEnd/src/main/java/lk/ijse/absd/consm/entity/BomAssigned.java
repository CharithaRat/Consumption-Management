...
//    }
    ...
    public BomAssigned(String BOM_USAGE, Bom bomA, Budget budget, double LENGTH, double WIDTH, double HEIGHT,
                       String COV_AREA_UNIT, double COV_AREA, double BOM_COST, String ASSIGN_DATE, double COST_PER_UNITAREA) {
        this.BOM_USAGE = BOM_USAGE;
        this.bomA = bomA;
        this.budget = budget;
        this.LENGTH = LENGTH;
    ...
    public BomAssigned(String BOM_USAGE, double LENGTH, double WIDTH, double HEIGHT, String COV_AREA_UNIT, double COV_AREA, double BOM_COST, String ASSIGN_DATE, double COST_PER_UNITAREA) {
        this.BOM_USAGE = BOM_USAGE;
        this.LENGTH = LENGTH;
        this.WIDTH = WIDTH;
        this.HEIGHT = HEIGHT;
    ...
    public BomAssigned(int BOM_ID, String BOM_USAGE, double LENGTH, double WIDTH, double HEIGHT, String COV_AREA_UNIT, double COV_AREA, double BOM_COST, String ASSIGN_DATE, double COST_PER_UNITAREA) {
        this.BOM_ID = BOM_ID;
        this.BOM_USAGE = BOM_USAGE;
        this.LENGTH = LENGTH;
        this.WIDTH = WIDTH;
