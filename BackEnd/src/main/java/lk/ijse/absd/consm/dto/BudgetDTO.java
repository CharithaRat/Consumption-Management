...
public class BudgetDTO {
    ...
    public BudgetDTO(String BUDGET_ID, String MODEL_ID, String XBOM_ID, String BOM_ID, String BOM_TYPE, String BOM_USAGE, double LENGTH, double WIDTH, double HEIGHT, double BOM_COST, double NO_OF_BOM_UNITS, double REQ_AREA, double COV_AREA_BY_CMT, double ACT_COST, String BUD_DATE, double TTL_BUDGET_COST) {
